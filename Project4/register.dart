...
*/
  ...
  void insertData()
  {
    var url1 = "https://vyasprakruti.000webhostapp.com/FlutterProject/register_insert.php";
    http.post(url1, body: {
...
/*
  ...
  Future viewMobileNoData() async {
    var url = "https://amisha1299.000webhostapp.com/Ewishes/Register/register_unique_mobileno_view.php";
