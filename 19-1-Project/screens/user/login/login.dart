...
class LoginPage extends State<Login> {
  ...
  Future<List> viewSessionData() async{
    ...
    Uri uri = Uri.parse("https://vyasprakruti.000webhostapp.com/FlutterProject/Register/register_session_view.php");

    final responce = await http.get(uri?data="+mobileno.text.toString());
 ...
 /* Future viewIdentifierData() async {
    var url = "https://vyasprakruti.000webhostapp.com/FlutterProject/Register/register_identifier_view.php";
